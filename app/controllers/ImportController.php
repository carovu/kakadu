...
class ImportController extends BaseKakaduController {
    ...
    public function postCheck() {
        ...
        if (File::extension($fileName) !== 'csv') {
            $message = array(trans('import.import_extension'));
            $parameters = array(Input::get('id'));
    ...
    public function getCheck() {
        ...
        if(!Session::has('import')) {
            $message = array(trans('import.no_import_available'));
    ...
    public function postSave() {
        ...
        return Redirect::route($redirect_success, $parameters);
    }
    ...
    private function redirectWithSyntaxError() {
        $message = array(trans('import.import_syntax'));
        $parameters = array(Input::get('id'));
