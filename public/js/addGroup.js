...
function test(){
	$.post(url+"/course/create", {_token: _token, name: "dsfadsafdsa", description: "dsfadsafdsadsfadsafdsadsfadsafdsadsfadsafdsadsfadsafdsadsfadsafdsa", groups: this.groups}
	, function(data) {
		$("body").html(data);
	});
}
